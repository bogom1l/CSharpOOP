namespace PlanetWars.Models.Planets
{
    ...
    public class Planet : IPlanet
    {
        ...
        private double CalculateMilitaryPower()
        {
            ...
            if (this._units.Models.Any(x => x.GetType().Name == nameof(AnonymousImpactUnit)))
            {
                sum *= 1.30;
            }

            if (this._weapons.FindByName(nameof(NuclearWeapon)) != null)
            {
                sum *= 1.45;
            }
        ...
        public void TrainArmy() => this._units.Models.ToList().ForEach(x => x.IncreaseEndurance());
